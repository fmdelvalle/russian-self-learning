...
interface MultipleChoiceToRussianProps {
  question: Question;
...
export function MultipleChoiceToRussian({
  question,
  onSubmit,
  onNext,
  pageMode,
  lastAnswer,
}: MultipleChoiceToRussianProps) {
      ...
      if (pageMode === 'ASKING') {
        ...
        if (key >= '1' && key <= '4') {
          ...
          if (options && options[optionIndex]) {
            const selectedValue = options[optionIndex].cyrillic;
  ...
  return (
    <>
      <h3 className="text-2xl font-bold mb-4">
        {t('questions.multipleChoiceToRussian', { spanish: question.word.spanish })}
      </h3>
